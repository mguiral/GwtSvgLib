...
public class SVGAnimatedTransformList extends JavaScriptObject {
    ...
    public final native SVGTransformList getBaseVal() /*-{
                                                      return this.baseVal ? @fr.hd3d.html5.svg.client.core.SVGTransformList::new(Lcom/google/gwt/core/client/JavaScriptObject;)(this.baseVal) : null;
                                                      }-*/;
    ...
    public final native SVGTransformList getAnimVal() /*-{
                                                      return this.animVal ? @fr.hd3d.html5.svg.client.core.SVGTransformList::new(Lcom/google/gwt/core/client/JavaScriptObject;)(this.animVal) : null;
                                                      }-*/;
}
