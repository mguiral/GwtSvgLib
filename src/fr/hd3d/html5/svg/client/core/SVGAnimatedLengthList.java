...
public class SVGAnimatedLengthList extends JavaScriptObject {
    ...
    public final native SVGLengthList getBaseVal() /*-{
                                                   return this.baseVal ? @fr.hd3d.html5.svg.client.core.SVGLengthList::new(Lcom/google/gwt/core/client/JavaScriptObject;)(this.baseVal) : null;
                                                   }-*/;
    ...
    public final native SVGLengthList getAnimVal() /*-{
                                                   return this.animVal ? @fr.hd3d.html5.svg.client.core.SVGLengthList::new(Lcom/google/gwt/core/client/JavaScriptObject;)(this.animVal) : null;
                                                   }-*/;
}
