...
public class SVGAnimatedNumberList extends JavaScriptObject {
    ...
    public final native SVGNumberList getBaseVal() /*-{
                                                   return this.baseVal ? @fr.hd3d.html5.svg.client.core.SVGNumberList::new(Lcom/google/gwt/core/client/JavaScriptObject;)(this.baseVal) : null;
                                                   }-*/;
    ...
    public final native SVGNumber getAnimVal() /*-{
                                               return this.animVal ? @fr.hd3d.html5.svg.client.core.SVGNumberList::new(Lcom/google/gwt/core/client/JavaScriptObject;)(this.animVal) : null;
                                               }-*/;
}
