...
public class SVGPathSegList implements Iterable<SVGPathSeg> {
    ...
    public final native int getNumberOfItems() /*-{
                                               return this.@fr.hd3d.html5.svg.client.core.SVGPathSegList::pathSeqListJSObject.numberOfItems;
                                               }-*/;
    ...
    public final native void clear() /*-{
                                     this.@fr.hd3d.html5.svg.client.core.SVGPathSegList::pathSeqListJSObject.clear();
                                     }-*/;
    ...
    public final native SVGPathSeg initialize(SVGPathSeg newItem) /*-{
                                                                  return this.@fr.hd3d.html5.svg.client.core.SVGPathSegList::pathSeqListJSObject.initialize(newItem);
                                                                  }-*/;
    ...
    public final native SVGPathSeg getItem(int index) /*-{
                                                      return this.@fr.hd3d.html5.svg.client.core.SVGPathSegList::pathSeqListJSObject.getItem(index);
                                                      }-*/;
    ...
    public final native SVGPathSeg insertItemBefore(SVGPathSeg newItem, int index) /*-{
                                                                                   return this.@fr.hd3d.html5.svg.client.core.SVGPathSegList::pathSeqListJSObject.insertItemBefore(newItem, index);
                                                                                   }-*/;
    ...
    public final native SVGPathSeg replaceItem(SVGPathSeg newItem, int index) /*-{
                                                                              return this.@fr.hd3d.html5.svg.client.core.SVGPathSegList::pathSeqListJSObject.replaceItem(newItem, index);
                                                                              }-*/;
    ...
    public final native SVGPathSeg removeItem(int index) /*-{
                                                         return this.@fr.hd3d.html5.svg.client.core.SVGPathSegList::pathSeqListJSObject.removeItem(index);
                                                         }-*/;
    ...
    public final native SVGPathSeg appendItem(SVGPathSeg newItem) /*-{
                                                                  return this.@fr.hd3d.html5.svg.client.core.SVGPathSegList::pathSeqListJSObject.appendItem(newItem);
                                                                  }-*/;
