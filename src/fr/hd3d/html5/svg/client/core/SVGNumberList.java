...
public class SVGNumberList implements Iterable<SVGNumber> {
    ...
    public final native int getNumberOfItems() /*-{
                                               return this.@fr.hd3d.html5.svg.client.core.SVGNumberList::numberListJSObject.numberOfItems;
                                               }-*/;
    ...
    public final native void clear() /*-{
                                     this.@fr.hd3d.html5.svg.client.core.SVGNumberList::numberListJSObject.clear();
                                     }-*/;
    ...
    public final native SVGNumber initialize(SVGNumber newItem) /*-{
                                                                return this.@fr.hd3d.html5.svg.client.core.SVGNumberList::numberListJSObject.initialize(newItem);
                                                                }-*/;
    ...
    public final native SVGNumber getItem(int index) /*-{
                                                     return this.@fr.hd3d.html5.svg.client.core.SVGNumberList::numberListJSObject.getItem(index);
                                                     }-*/;
    ...
    public final native SVGNumber insertItemBefore(SVGNumber newItem, int index) /*-{
                                                                                 return this.@fr.hd3d.html5.svg.client.core.SVGNumberList::numberListJSObject.insertItemBefore(newItem, index);
                                                                                 }-*/;
    ...
    public final native SVGNumber replaceItem(SVGNumber newItem, int index) /*-{
                                                                            return this.@fr.hd3d.html5.svg.client.core.SVGNumberList::numberListJSObject.replaceItem(newItem, index);
                                                                            }-*/;
    ...
    public final native SVGNumber removeItem(int index) /*-{
                                                        return this.@fr.hd3d.html5.svg.client.core.SVGNumberList::numberListJSObject.removeItem(index);
                                                        }-*/;
    ...
    public final native SVGNumber appendItem(SVGNumber newItem) /*-{
                                                                return this.@fr.hd3d.html5.svg.client.core.SVGNumberList::numberListJSObject.appendItem(newItem);
                                                                }-*/;
