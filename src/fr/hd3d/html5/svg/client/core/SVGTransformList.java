...
import fr.hd3d.html5.svg.client.core.SVGTransform.TransformUnit;
...
public class SVGTransformList implements Iterable<SVGTransform> {
    ...
    public final native int getNumberOfItems() /*-{
                                               return this.@fr.hd3d.html5.svg.client.core.SVGTransformList::transformListJSObject.numberOfItems;
                                               }-*/;
    ...
    public final native void clear() /*-{
                                     this.@fr.hd3d.html5.svg.client.core.SVGTransformList::transformListJSObject.clear();
                                     }-*/;
    ...
    public final native SVGTransform initialize(SVGTransform newItem) /*-{
                                                                      return this.@fr.hd3d.html5.svg.client.core.SVGTransformList::transformListJSObject.initialize(newItem);
                                                                      }-*/;
    ...
    public final native SVGTransform getItem(int index) /*-{
                                                        return this.@fr.hd3d.html5.svg.client.core.SVGTransformList::transformListJSObject.getItem(index);
                                                        }-*/;
    ...
    public final native SVGTransform insertItemBefore(SVGTransform newItem, int index) /*-{
                                                                                       return this.@fr.hd3d.html5.svg.client.core.SVGTransformList::transformListJSObject.insertItemBefore(newItem, index);
                                                                                       }-*/;
    ...
    public final native SVGTransform replaceItem(SVGTransform newItem, int index) /*-{
                                                                                  return this.@fr.hd3d.html5.svg.client.core.SVGTransformList::transformListJSObject.replaceItem(newItem, index);
                                                                                  }-*/;
    ...
    public final native SVGTransform removeItem(int index) /*-{
                                                           return this.@fr.hd3d.html5.svg.client.core.SVGTransformList::transformListJSObject.removeItem(index);
                                                           }-*/;
    ...
    public final native SVGTransform appendItem(SVGTransform newItem) /*-{
                                                                      return this.@fr.hd3d.html5.svg.client.core.SVGTransformList::transformListJSObject.appendItem(newItem);
                                                                      }-*/;
    ...
    public final native SVGTransform createSVGTransformFromMatrix(SVGMatrix matrix) /*-{
                                                                                    return this.@fr.hd3d.html5.svg.client.core.SVGTransformList::transformListJSObject.createSVGTransformFromMatrix(matrix);
                                                                                    }-*/;
    ...
    public final native SVGTransform consolidate() /*-{
                                                   return this.@fr.hd3d.html5.svg.client.core.SVGTransformList::transformListJSObject.consolidate();
                                                   }-*/;
