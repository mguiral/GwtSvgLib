...
import fr.hd3d.html5.svg.client.core.SVGAngle.AngleUnitType;
...
public class PresentationStyle {
    ...
    private native String getPropertyImpl(String name) /*-{
                                                       return this.@fr.hd3d.html5.svg.client.dom.PresentationStyle::element[name];
                                                       }-*/;
    ...
    private native void setPropertyImpl(String uri, String name, String value) /*-{
                                                                               this.@fr.hd3d.html5.svg.client.dom.PresentationStyle::element.setAttributeNS(uri, name, value);
                                                                               }-*/;
}
