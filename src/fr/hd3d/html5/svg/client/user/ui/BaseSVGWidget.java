...
import fr.hd3d.html5.svg.client.ISVGElement;
import fr.hd3d.html5.svg.client.core.SVGAnimatedString;
import fr.hd3d.html5.svg.client.dom.PresentationStyle;
...
public abstract class BaseSVGWidget extends ComplexPanel implements ISVGElement {
    ...
    protected final native void addAbortEventHandler() /*-{
                                                       var svgElement = this.@fr.hd3d.html5.svg.client.user.ui.BaseSVGWidget::element;
                                                       var svgWidget = this;
                                                       svgElement.addEventListener('abort', function(){
                                                       var event = @fr.hd3d.html5.svg.client.user.events.AbortEvent::new()();
                                                       svgWidget.@fr.hd3d.html5.svg.client.user.ui.BaseSVGWidget::fireEvent(Ljava/lang/Object;)(event);
                                                       }, true);
                                                       }-*/;
    ...
    protected final native void addActivateEventHandler() /*-{
                                                          ...
                                                          var event = @fr.hd3d.html5.svg.client.user.events.ActivateEvent::new()();
                                                          svgWidget.@fr.hd3d.html5.svg.client.user.ui.BaseSVGWidget::fireEvent(Ljava/lang/Object;)(event);
                                                          }, true);
                                                          }-*/;
    ...
    protected final native void addZoomEventHandler() /*-{
                                                      ...
                                                      var event = @fr.hd3d.html5.svg.client.user.events.ZoomEvent::new()();
                                                      svgWidget.@fr.hd3d.html5.svg.client.user.ui.BaseSVGWidget::fireEvent(Ljava/lang/Object;)(event);
                                                      }, true);
                                                      }-*/;
