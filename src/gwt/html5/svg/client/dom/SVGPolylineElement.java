...
public class SVGPolylineElement extends SVGGraphicalElement {
    ...
    public final native SVGPointList getPoints() /*-{
                                                 return this.points ? @gwt.html5.svg.client.core.SVGPointList::new(Lcom/google/gwt/core/client/JavaScriptObject;)(this.points) : null;
                                                 }-*/;
    ...
    public final native SVGPointList getAnimatedPoints() /*-{
                                                         return this.animatedPoints ? @gwt.html5.svg.client.core.SVGPointList::new(Lcom/google/gwt/core/client/JavaScriptObject;)(this.animatedPoints) : null;
                                                         }-*/;
}
