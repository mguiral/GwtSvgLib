...
public class SVGPathElement extends SVGGraphicalElement {
    ...
    public final native SVGPathSegList getPathSegList() /*-{
                                                        return this.pathSegList ? @gwt.html5.svg.client.core.SVGPathSegList::new(Lcom/google/gwt/core/client/JavaScriptObject;)(this.pathSegList) : null;
                                                        }-*/;
    ...
    public final native SVGPathSegList getNormalizedPathSegList() /*-{
                                                                  return this.normalizedPathSegList ? @gwt.html5.svg.client.core.SVGPathSegList::new(Lcom/google/gwt/core/client/JavaScriptObject;)(this.normalizedPathSegList) : null;
                                                                  }-*/;
    ...
    public final native SVGPathSegList getAnimatedPathSegList() /*-{
                                                                return this.animatedPathSegList ? @gwt.html5.svg.client.core.SVGPathSegList::new(Lcom/google/gwt/core/client/JavaScriptObject;)(this.animatedPathSegList) : null;
                                                                }-*/;
    ...
    public final native SVGPathSegList getAnimatedNormalizedPathSegList() /*-{
                                                                          return this.animatedNormalizedPathSegList ? @gwt.html5.svg.client.core.SVGPathSegList::new(Lcom/google/gwt/core/client/JavaScriptObject;)(this.animatedNormalizedPathSegList) : null;
                                                                          }-*/;
}
