...
public class SVGPointList implements Iterable<SVGPoint> {
    ...
    public final native int getNumberOfItems() /*-{
                                               return this.@gwt.html5.svg.client.core.SVGPointList::pointListJSObject.numberOfItems;
                                               }-*/;

    public final native void clear() /*-{
                                     this.@gwt.html5.svg.client.core.SVGPointList::pointListJSObject.clear();
                                     }-*/;

    public final native SVGPoint initialize(SVGPoint newItem) /*-{
                                                              return this.@gwt.html5.svg.client.core.SVGPointList::pointListJSObject.initialize(newItem);
                                                              }-*/;

    public final native SVGPoint getItem(int index) /*-{
                                                    return this.@gwt.html5.svg.client.core.SVGPointList::pointListJSObject.getItem(index);
                                                    }-*/;

    public final native SVGPoint insertItemBefore(SVGPoint newItem, int index) /*-{
                                                                               return this.@gwt.html5.svg.client.core.SVGPointList::pointListJSObject.insertItemBefore(newItem, index);
                                                                               }-*/;

    public final native SVGPoint replaceItem(SVGPoint newItem, int index) /*-{
                                                                          return this.@gwt.html5.svg.client.core.SVGPointList::pointListJSObject.replaceItem(newItem, index);
                                                                          }-*/;

    public final native SVGPoint removeItem(int index) /*-{
                                                       return this.@gwt.html5.svg.client.core.SVGPointList::pointListJSObject.removeItem(index);
                                                       }-*/;

    public final native SVGPoint appendItem(SVGPoint newItem) /*-{
                                                              return this.@gwt.html5.svg.client.core.SVGPointList::pointListJSObject.appendItem(newItem);
                                                              }-*/;
