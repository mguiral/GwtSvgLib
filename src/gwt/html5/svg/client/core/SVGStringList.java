...
public class SVGStringList implements Iterable<String> {
    ...
    public final native int getNumberOfItems() /*-{
                                               return this.@gwt.html5.svg.client.core.SVGStringList::stringListJSObject.numberOfItems;
                                               }-*/;
    ...
    public final native void clear() /*-{
                                     this.@gwt.html5.svg.client.core.SVGStringList::stringListJSObject.clear();
                                     }-*/;
    ...
    public final native String initialize(String newItem) /*-{
                                                          return this.@gwt.html5.svg.client.core.SVGStringList::stringListJSObject.initialize(newItem);
                                                          }-*/;
    ...
    public final native String getItem(int index) /*-{
                                                  return this.@gwt.html5.svg.client.core.SVGStringList::stringListJSObject.getItem(index);
                                                  }-*/;
    ...
    public final native String insertItemBefore(String newItem, int index) /*-{
                                                                           return this.@gwt.html5.svg.client.core.SVGStringList::stringListJSObject.insertItemBefore(newItem, index);
                                                                           }-*/;
    ...
    public final native String replaceItem(String newItem, int index) /*-{
                                                                      return this.@gwt.html5.svg.client.core.SVGStringList::stringListJSObject.replaceItem(newItem, index);
                                                                      }-*/;
    ...
    public final native String removeItem(int index) /*-{
                                                     return this.@gwt.html5.svg.client.core.SVGStringList::stringListJSObject.removeItem(index);
                                                     }-*/;
    ...
    public final native String appendItem(String newItem) /*-{
                                                          return this.@gwt.html5.svg.client.core.SVGStringList::stringListJSObject.appendItem(newItem);
                                                          }-*/;
