...
public class SVGLengthList implements Iterable<SVGLength> {
    ...
    public final native int getNumberOfItems() /*-{
                                               return this.@gwt.html5.svg.client.core.SVGLengthList::lengthListJSObject.numberOfItems;
                                               }-*/;
    ...
    public final native void clear() /*-{
                                     this.@gwt.html5.svg.client.core.SVGLengthList::lengthListJSObject.clear();
                                     }-*/;
    ...
    public final native SVGLength initialize(SVGLength newItem) /*-{
                                                                return this.@gwt.html5.svg.client.core.SVGLengthList::lengthListJSObject.initialize(newItem);
                                                                }-*/;
    ...
    public final native SVGLength getItem(int index) /*-{
                                                     return this.@gwt.html5.svg.client.core.SVGLengthList::lengthListJSObject.getItem(index);
                                                     }-*/;
    ...
    public final native SVGLength insertItemBefore(SVGLength newItem, int index) /*-{
                                                                                 return this.@gwt.html5.svg.client.core.SVGLengthList::lengthListJSObject.insertItemBefore(newItem, index);
                                                                                 }-*/;
    ...
    public final native SVGLength replaceItem(SVGLength newItem, int index) /*-{
                                                                            return this.@gwt.html5.svg.client.core.SVGLengthList::lengthListJSObject.replaceItem(newItem, index);
                                                                            }-*/;
    ...
    public final native SVGLength removeItem(int index) /*-{
                                                        return this.@gwt.html5.svg.client.core.SVGLengthList::lengthListJSObject.removeItem(index);
                                                        }-*/;
    ...
    public final native SVGLength appendItem(SVGLength newItem) /*-{
                                                                return this.@gwt.html5.svg.client.core.SVGLengthList::lengthListJSObject.appendItem(newItem);
                                                                }-*/;
